...
const RUBRIC_CATEGORIES = [
  ...
  { name: "Eyes", icon: "👁️", desc: "Vision, Pain" },
  { name: "Ears", icon: "👂", desc: "Hearing, Tinnitus" },
  { name: "Nose", icon: "👃", desc: "Cold, Sinusitis" },
  { name: "Throat", icon: "🫁", desc: "Pain, Infection" },
  { name: "Chest", icon: "❤️", desc: "Lungs, Heart" },
  { name: "Stomach", icon: "🫃", desc: "Digestion, Nausea" },
  { name: "Abdomen", icon: "🔵", desc: "Pain, Bloating" },
  { name: "Back", icon: "🦴", desc: "Spine, Pain" },
